...
-- Tiempo de generación: 17-03-2026 a las 19:43:45
...
--
-- Base de datos: `hojalate_proyectoweb2`
--
...
--
-- Volcado de datos para la tabla `rutas_catalogo`
--

INSERT INTO `rutas_catalogo` (`id_ruta_catalogo`, `nombre_ruta`, `descripcion`, `created_at`) VALUES
(1, 'Ruta General', 'Ruta principal de reparto', '2026-03-18 01:23:30');
...
(3, 'angel', 'repartidor', '123', '2026-03-13 06:05:16'),
(4, 'pancho', 'repartidor', '123', '2026-03-13 06:05:16');
...
--
ALTER TABLE `rutas_catalogo`
  MODIFY `id_ruta_catalogo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
